...
class ForgotPasswordRequests(models.Model):
  id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
  user = models.ForeignKey(Users, on_delete=models.CASCADE,related_name='forgot_password_requests')
  ...
  def __str__(self): return f"ForgotPasswordRequest for {self.user.username} at {self.created_at}"
